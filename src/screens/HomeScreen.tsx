  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate(ROUTES.PROFILE)} activeOpacity={0.8}>
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: COLORS.backgroundWarm, justifyContent: 'center' },
  ...
  subtitle: { fontSize: 16, color: COLORS.textMuted, marginBottom: SPACING.xl, letterSpacing: 2 },
  button: {
